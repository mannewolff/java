...
class ResizeControllerTest {
    ...
    void shouldReturnResizedImageWithUpstreamContentType() throws Exception {
        ...
        final MockMultipartFile upload = new MockMultipartFile(
                "file", "photo.png", MediaType.IMAGE_PNG_VALUE, "raw".getBytes());

        mockMvc.perform(multipart("/api/tools/resize")
                        .file(upload)
                        .param("width", "400")
                        .param("height", "300"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.IMAGE_JPEG))
                .andExpect(header().string("Content-Disposition", "attachment; filename=\"resized-400x300.jpg\""))
    ...
    void shouldUsePngExtensionForPngOutput() throws Exception {
        ...
        mockMvc.perform(multipart("/api/tools/resize")
                        ...
                        .param("width", "100")
                        .param("height", "100"))
                .andExpect(header().string("Content-Disposition", "attachment; filename=\"resized-100x100.png\""));
    }
    ...
    void shouldUseWebpExtensionForWebpOutput() throws Exception {
        ...
        final MockMultipartFile upload = new MockMultipartFile(
                "file", "photo.webp", "image/webp", "raw".getBytes());

        mockMvc.perform(multipart("/api/tools/resize")
                        .file(upload)
                        .param("width", "100")
                        .param("height", "100"))
                .andExpect(header().string("Content-Disposition", "attachment; filename=\"resized-100x100.webp\""));
    }
    ...
    void shouldUseBinExtensionForUnknownOutput() throws Exception {
        ...
        mockMvc.perform(multipart("/api/tools/resize")
                        ...
                        .param("width", "100")
                        .param("height", "100"))
                .andExpect(header().string("Content-Disposition", "attachment; filename=\"resized-100x100.bin\""));
    }

...
| [CLAUDE-java.md](CLAUDE-java.md) | Java 25, Spring Boot 3, TDD, Coverage, Mutationstests |
...
Java 25 + Spring Boot 3 (TDD-pflichtig, 100 % Coverage), React 18 + TypeScript strict + MUI.

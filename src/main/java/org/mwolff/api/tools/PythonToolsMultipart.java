 ...
 *
 * Liefert ein {@link MultiValueMap} mit einem korrekt benannten file-Part
 * (passender Content-Type, filename ueber {@link ByteArrayResource#getFilename}).
 * Zusaetzliche Form-Felder werden vom Aufrufer per {@code body.add(...)} ergaenzt.
 */

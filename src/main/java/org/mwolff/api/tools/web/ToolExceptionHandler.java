...
/**
 * Tool-spezifischer Exception-Handler im Web-Adapter. Mapped Domain-Exceptions ({@link
 * InvalidUploadException}, {@link PythonToolsException}) auf HTTP-Antworten. Greift paket-skopiert
 * nur für Controller in {@code org.mwolff.api.tools.web.**}.
 */
@RestControllerAdvice(basePackages = "org.mwolff.api.tools.web")
